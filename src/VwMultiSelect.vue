            ...
            >
                <template v-if="tags">
                    ...
                    >{{ selectedListDisplayFunction(item) }}
                        ...
                        <template v-else="">
                            <span :class="_classes.removeIcon" :style="_styles.removeIcon">✖</span>
                        </template>
                    </span>
                </template>
        ...
        >
            <template v-if="showSelectedFirst">
                ...
                >
                    ...
                    <template v-else="">
                        <input type="checkbox" checked="checked" :style="_styles.selectedIcon" />
                    </template>
                    <span
                ...
                >
                    ...
                    <template v-else="">
                        <input type="checkbox" :value="false" :style="_styles.unselectedIcon" />
                    </template>
            ...
            <template v-else="">
                <div
                    ...
                    "
                        :style="
                        isItemSelected(item) ? _styles.selectedListItem : _styles.unselectedListItem
                    "
                        @click="() => toggleItem(item)"
                >
